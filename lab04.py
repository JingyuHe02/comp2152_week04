...
input("Roll for firtst item (Press Enter)")
lootRool = random.choice(1, len(loot_options)+1)
loot  = loot_options.pop(lootRool-1)
belt.append(loot)
...
#Lab04 Q3
#Increase the monster's combat strength based on the power
m_combat_strength = min(6, m_combat_strength + monster_powers[power_roll])
print("The monster combat is strength is now "+ str(m_combat_strength) + " using the " + power_roll + "magic power")
